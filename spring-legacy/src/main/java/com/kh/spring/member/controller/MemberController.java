...
@Controller // ComponentScan에 의해 bean객체를 등록시키게하는 속성
...
//	}
	 ...
	 */
//	public String login(
//			@RequestParam(value="userId",defaultValue="크로클")
//			String userId) {
...
//		 *  - 기본적으로 request scope를 가지고 있으며, 설정을 통해 session scope에도
//		 *  데이터를 담을 수 있다.
...
//	}
	 ...
	 *  - 컨트롤러에 예외처리 메서드를 1개 추가한 후, @ExceptionHandler어노테이션 추가.
	 *  - 2순위로 적용
